...
class RecommendationRecord(Base):
    ...
    strategy_segment: Mapped[str] = mapped_column(String(160), index=True, nullable=True)
    research_tags: Mapped[list] = mapped_column(JSON, nullable=False, default=list)
    research_evidence: Mapped[dict] = mapped_column(JSON, nullable=False, default=dict)
