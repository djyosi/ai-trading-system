...
class RecommendationRepository:
    ...
    def save_recommendation(self, recommendation, created_at=None):
        record = RecommendationRecord(
            ...
            strategy_segment=recommendation.get("strategy_segment"),
            research_tags=recommendation.get("research_tags", []),
            research_evidence=recommendation.get("research_evidence", {}),
